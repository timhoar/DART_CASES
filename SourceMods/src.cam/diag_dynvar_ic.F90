! This file is
! /gpfs/fs1/work/raeder/Models/cesm2_1_relsd_m5.6/components/cam/src/dynamics/fv/diag_dynvar_ic.F90
! modified to convert dry constituents from wet to dry before writing to initial files,
! where they are now labeled dry.
