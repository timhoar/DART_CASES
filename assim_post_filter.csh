#!/bin/csh
#
#PBS  -N assim_post_filter.csh
#PBS  -A NCIS0006
#        vvvvvvvv  
#PBS  -q R8963873
#        2019-10-28 ... 11-30
#        ^^^^^^^^
# assimilate_post_filter.csh just compresses forcing files; 5 x 80 = 400
...
#          which starts after all variables are set and ends just before the
#          place where assimilate.csh died.  See SKIP.
#          This usually does compression in parallel, 
#          so run it as a standalone job with enough processors for that
#
...
# SKIP
setenv CASEROOT /glade/work/raeder/Exp/f.e21.FHIST_BGC.f09_025.CAM6assim.011
@ cycle = 1
setenv DATA_ASSIMILATION_CYCLES  1
# setenv CASEROOT $1
# @ cycle = $2 + 1
