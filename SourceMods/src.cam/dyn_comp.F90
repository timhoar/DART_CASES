! This file is
! /gpfs/fs1/work/raeder/Models/cesm2_1_relsd_m5.6/components/cam/src/dynamics/fv/dyn_comp.F90
! modified to correctly handle initial file constituents with and without the mixing_ratio attribute.
