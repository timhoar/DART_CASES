...
! /gpfs/fs1/work/raeder/Models/cesm2_1_relsd_m5.6/components/cam/src/control/cam_history_support.F90
! to keep better track of wet or dry mixing ratio in initial files.
